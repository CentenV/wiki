...
>(({ className, ...props }, ref) => (
  <div className="rounded-wiki border-wiki-default border-wiki-hud-border-color relative w-full overflow-auto">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle font-normal text-neutral-500 [&:has([role=checkbox])]:pr-0 dark:text-neutral-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("font-bold p-4 align-middle [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
