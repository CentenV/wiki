        ...
        <div className="flex flex-col gap-2 h-full">
            {
                Object.entries(pages).map(([pagePath, data]) => {
                    ...
                    return (
                        <a href={destinationUrl} className="flex flex-row p-2 pl-4 border-wiki-default hover:border-wiki-hud-border-color border-wiki-hud-border-color lg:border-wiki-background-color rounded-wiki gap-2">
